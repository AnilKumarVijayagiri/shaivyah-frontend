      ...
      <footer className="bg-white border-t border-gray-200 mt-12">
        <div className="container mx-auto px-6 py-12 grid sm:grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1 text-sm text-gray-600">
              <li><a href="https://www.instagram.com/shaivyah_?igsh=dmRlczI2MXh3YTc2">Instagram</a></li>
              <li><a href="https://www.youtube.com/@Shaivyah">Youtube</a></li>
              <li><a href="https://www.facebook.com/1CStpxKe1H/">Facebook</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-serif font-bold text-lg mb-2">Address</h4>
            <p className="text-sm text-gray-600">
              📍City-Hyderabad<br /> 🇮🇳 Shipping Across India<br />📞+91 8125914279<br />
            </p>
          </div>
        </div>
      </footer>
